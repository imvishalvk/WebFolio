...
function NavHead() {
  return (
    <div class="sticky top-0 z-50 bg-gray-900/80 backdrop-blur-md border-b border-gray-800">
      <header class=" inset-x-0 top-0 z-50 ">
        <nav aria-label="Global" class="flex items-center justify-between p-6 lg:px-8">
          ...
          <div class="hidden lg:flex lg:gap-x-12">
            ...
            <a href="#technologies" class="text-sm/6 font-semibold text-white">Features</a>
          ...
          <div class="hidden lg:flex lg:flex-1 lg:justify-end">
            {/* <a href="#" class="text-sm/6 font-semibold text-white">Connect Now <span aria-hidden="true">&rarr;</span></a> */}
            <a
              href="#contact"
              ...
              <el-dialog-panel class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-gray-900 p-6 sm:max-w-sm sm:ring-1 sm:ring-gray-100/10">
                ...
                <div class="mt-6 flow-root">
                  <div class="-my-6 divide-y divide-white/10">
                    ...
                    <div class="py-6">
                      {/* <a href="#" class="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-white hover:bg-white/5">Connect Now</a> */}
                      <a
                        href="#contact"
                        className="inline-block bg-indigo-500 hover:bg-indigo-600 text-white font-semibold px-8 py-3 rounded-lg transition duration-300 transform hover:scale-105"
                      >
