...
const plans = [
  {
    ...
    timeline: "3–5 days",
    description:
      "A clean, conversion-focused landing page to establish your online presence and attract customers.",
    color: "indigo",
    features: [
      "Single page design",
  ...
  },
  {
    ...
    timeline: "1–3 weeks",
    description:
      "A modern single-page React application tailored to your project scope, complexity, and time requirements.",
    color: "indigo",
    features: [
  ...
  },
  {
    ...
    timeline: "3–4 weeks",
    description:
      "Complete full stack solution with React frontend, Node.js backend, and a full-featured admin panel.",
    color: "indigo",
    features: [
  ...
  },
  {
    ...
    timeline: "4–6 weeks",
    description:
      "A fully featured e-commerce platform with storefront, cart, payments, and complete admin control.",
    color: "indigo",
    features: [
    ...
    <div className="relative isolate bg-gray-900 px-6 py-24 sm:py-32 lg:px-8">
      ...
      >
        <div
          ...
          className="mx-auto aspect-[1155/678] w-[72rem] bg-gradient-to-tr from-[#80b5ff] to-[#fc89ea] opacity-10"
        />
      </div>

      {/* Heading */}
      <div className="mx-auto max-w-4xl text-center">
        <h2 className="text-base font-semibold text-indigo-400 tracking-widest uppercase">
          Pricing
        </h2>
      ...
      <div className="mx-auto mt-16 grid max-w-7xl grid-cols-1 gap-8 sm:grid-cols-2 xl:grid-cols-4">
        {plans.map((plan, i) => (
          <div
            ...
            className={`
              relative flex flex-col rounded-3xl p-8 ring-1 transition-all duration-300 cursor-default
              ${plan.highlight
                ? "bg-gray-800 ring-indigo-500 shadow-xl shadow-indigo-500/20"
                : "bg-white/5 ring-white/10 backdrop-blur-sm"
              }
              ${hovered === i && !plan.highlight ? "ring-indigo-500 shadow-lg shadow-indigo-500/10" : ""}
              ${hovered === i && plan.highlight ? "shadow-2xl shadow-indigo-500/30 -translate-y-1" : ""}
            `}
          >
            {/* Popular badge */}
            {plan.highlight && (
            ...
            {/* Plan tag & name */}
            <div>
              <h3 className="text-sm font-semibold text-indigo-400 tracking-widest uppercase">
                {plan.tag}
              </h3>
            ...
            {/* Description */}
            <p className="mt-5 text-sm text-gray-400 leading-relaxed flex-shrink-0">
              {plan.description}
            </p>
            ...
            <a
              href="#contact"
              className={`
                mt-8 block rounded-xl px-4 py-3 text-center text-sm font-semibold transition-all duration-200
                ${plan.highlight
                  ? "bg-indigo-500 text-white hover:bg-indigo-400 shadow-lg shadow-indigo-500/30 hover:shadow-indigo-400/40"
      ...
      <div className="mx-auto mt-16 max-w-2xl text-center">
        <p className="text-sm text-gray-500">
          ...
          <a href="#contact" className="text-indigo-400 underline underline-offset-2 hover:text-indigo-300 transition">
            Contact me
          </a>{" "}
          for a custom quote based on your exact requirements.
          Free 30-min discovery call included with every project.
        </p>
      </div>
