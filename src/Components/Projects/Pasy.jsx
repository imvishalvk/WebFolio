...
import compPics from '../../assets/Web Designs/Pasy .png'
import { FaHtml5, FaCss3, FaShopify } from "react-icons/fa";
import { Parallax } from "react-scroll-parallax";

function Pasy() {
  return (
    <div  className="overflow-hidden bg-gray-900 py-15 items-center">
      <div className="mx-auto max-w-7xl px-6 lg:px-8 ">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          ...
          <div className="">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-6 text-lg text-gray-300">
                Pasy online is an Ecommerece website which deals with unique and trendy products needed website for handle the online store using Shopify.
              </p>
              ...
              <dl className="mt-10 max-w-xl space-y-8 text-base text-gray-400 lg:max-w-none">
                ...
                <div className="relative pl-10">
                  <dt className="font-semibold text-white flex items-center gap-3">
                    <FaShopify className="text-[#95BF47] text-2xl" />
                    Shopify
                  </dt>
                  <dd className="mt-1">
          ...
          <a href="https://www.pasyonline.com/" target="_blank" className="relative group overflow-hidden rounded-xl items-center flex">
