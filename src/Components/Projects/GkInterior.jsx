...
import compPics from '../../assets/Web Designs/GK Interior.png'
    ...
    <Parallax speed={5} className="overflow-hidden bg-gray-900 py-15 items-center">
      <div className="mx-auto max-w-7xl px-6 lg:px-8 ">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          ...
          <div className="">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-2 text-4xl font-semibold tracking-tight text-white sm:text-5xl">
                GK Interior and Constructions
              </p>

              <p className="mt-6 text-lg text-gray-300">
                GK Interior and Constructions is a construction company which deals with the real estate projects needed website for online presence in the market.
              </p>
          ...
          <a href="https://www.gkinteriorandconstruction.com/" target="_blank" className="relative group overflow-hidden rounded-xl items-center flex">
